...
import { type ChoicesProps, type RaRecord, type SupportCreateSuggestionOptions, type UseSuggestionsOptions } from 'ra-core';
import * as React from 'react';
import { type ReactNode } from 'react';
import type { CommonInputProps } from "./CommonInputProps.cjs";
/**
 ...
 */
export declare const AutocompleteInput: <OptionType extends RaRecord = RaRecord, Multiple extends boolean | undefined = false, DisableClearable extends boolean | undefined = boolean | undefined, SupportCreate extends boolean | undefined = false>(inProps: AutocompleteInputProps<OptionType, Multiple, DisableClearable, SupportCreate>) => string | number | true | Iterable<React.ReactNode> | React.JSX.Element | null;
export declare const AutocompleteInputClasses: {
    textField: string;
    emptyLabel: string;
};
export interface AutocompleteInputProps<OptionType extends any = RaRecord, Multiple extends boolean | undefined = false, DisableClearable extends boolean | undefined = false, SupportCreate extends boolean | undefined = false> extends Omit<CommonInputProps, 'source' | 'onChange'>, Omit<ChoicesProps, 'disableValue'>, UseSuggestionsOptions, Omit<SupportCreateSuggestionOptions, 'handleChange' | 'optionText'>, Omit<AutocompleteProps<OptionType, Multiple, DisableClearable, SupportCreate>, 'onChange' | 'options' | 'renderInput'> {
    children?: ReactNode;
    debounce?: number;
    emptyText?: string;
    emptyValue?: any;
